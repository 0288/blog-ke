...
<div class="card container col-8" style="padding-top: 5px; margin-top: 20px;">
  <h2 style="text-align: center;">Configuraciones</h2>
  <div class="card-body">
    <div class="alert alert-primary" role="alert">
      <a href="alterar.php?alteracao=1">Cambiar nombre de usuario</a><br/><br/>
    </div>
    <div class="alert alert-success" role="alert">
      <a href="alterar.php?alteracao=2">Cambiar E-mail</a><br/><br/>
    </div>
    <div class="alert alert-danger" role="alert">
      <a href="alterar.php?alteracao=3">Cambiar contrseña</a><br/><br/>
    </div>
    <div class="alert alert-dark" role="alert">
      <a href="alterar.php?alteracao=4">Eliminar cuenta</a><br/><br/>
    </div>
  </div>
</div>
